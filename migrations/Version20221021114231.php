 ...
 */
final class Version20221021114231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE internally_displaced_persons (id VARCHAR(3) NOT NULL, country VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE internally_displaced_persons_values (id VARCHAR(30) NOT NULL, parent_id VARCHAR(3) DEFAULT NULL, year INT NOT NULL, conflict_stock_displacement NUMERIC(20, 0) DEFAULT NULL, conflict_internal_displacements NUMERIC(20, 0) DEFAULT NULL, disaster_internal_displacements NUMERIC(20, 0) DEFAULT NULL, disaster_stock_displacement NUMERIC(20, 0) DEFAULT NULL, INDEX IDX_8174CE4C727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
